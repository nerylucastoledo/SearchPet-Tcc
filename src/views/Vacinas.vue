<template>
    <div class="container">
        ...
        <div class="vacina-intro">
            <div>
                <p>As vacinas desempenham um papel fundamental para a saúde e bem estar dos pets. Com esse gesto de carinho, os tutores ajudam a prevenir doenças graves, que podem surgir em qualquer fase da vida do animal e botar em risco toda a família.</p>
            </div>

            <div>
                <p>Doenças graves como a Leishmaniose e a Raiva podem ser transmitidas dos cães para os humanos. E mesmo as doenças menos graves e não transmissíveis costumam gerar grandes estresses psicológicos e financeiros, que poderiam ser evitados com as vacinas para dos pets.</p>
            </div>
        </div>
        ...
        <div class="vacina-intro box-primeiros-dias">
            ...
            <div>
                <p>As primeiras vacinas para cães devem ser aplicadas entre os primeiros <strong>42</strong> a <strong>45 dias</strong> de vida do pet. até essa data, os filhotes, em geral, são imunizados pela mãe através do colostro, o leite mamado nas primeiras <strong>48-72h</strong> de vida do filhote.</p>
            </div>
        </div>
        ...
        <div class="vacina-intro box-primeiros-dias">
            ...
            <div>
                <p>A partir dos primeiros <strong>60 dias</strong> de vida, os felinos devem ser vacinados com a primeira dose da <strong>Vacina Quádrupla (V4)</strong> ou <strong>Quíntupla (V5)</strong> Felina. <strong>21</strong> a <strong>30 dias</strong> após, aplicamos a segunda dose de reforço das mesmas.</p>
            </div>
        </div>

        <h1 class="titulo-primeiro-dias titulo">Vacinas de reforço</h1>

        <div class="vacina-reforco">
            <p>Tanto na fase de filhotes, como na fase adulta, as vacinas para cães são calculada pelos médicos veterinários de acordo com uma curva imunológica.</p>
            <p>Vale lembrar que após a aplicação das vacinas, a imunização leva ainda algumas semanas para acontecer. Nesse período, o animal deve continuar protegido, sem contato com outros animais.  </p>
            <p>Cabe ao médico veterinário analisar a situação de cada pet e montar um protocolo específico para a realidade de cada família.</p>
        </div>

        <h1 class="titulo-primeiro-dias titulo">Principais vacina para cães 🐶</h1>
        ...
        <h1 class="titulo-primeiro-dias titulo">Principais vacina para gatos 😺</h1>
...
.titulo-primeiro-dias {
    text-align: unset !important;
}

.titulo-primeiro-dias:before {
...
.principais-vacinas div:nth-child(1) {
    margin-right: 30px;
}

.principais-vacinas h2 {
    text-align: center;
    margin-bottom: 20px;
    color: #222;
}

.principais-vacinas strong {
    color: #36C9D2;
}

.principais-vacinas p {
    padding: 20px;
    max-width: 650px;
}
